...
import MadeToOrderFancoil from "./components/MadeToOrderFancoil/MadeToOrderFancoil";
    ...
    <div className={styles.app}>
      <SimpleReactLightbox>
        ...
        <Route
          ...
          exact
          render={() => {
            return <AccessoriesModelContainer />;
          }}
        />
        <Route
          path="/accessories/"
          exact
          render={() => {
            return <AccessoriesPageContainer />;
          }}
        />
        <Route
          path="/contacts"
