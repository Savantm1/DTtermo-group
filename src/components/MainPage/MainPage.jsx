...
let MainPage = (props) => {
  debugger;
  let AccessoriesPopularElements = props.data.accessoriesTypes
    .filter((element) => element.popular === 1)
    .map((element) => {
      return (
        <AccessoryItem
          key={element.id}
  ...
  return (
    <div className={styles.content}>
      ...
      <h2 className={styles.title} id="accessories">
        Основные аксессуары для фанкойлов
      </h2>

      <div className={styles.cards_block}>{AccessoriesPopularElements}</div>
