      ...
      <div className={styles.card}>
        <div className={styles.card__container}>
          ...
          <div className={styles.desc_block}>
            <h4 className={styles.card__title}>Аксессуары для компрессорно-конденсаторных блоков</h4>
            <p className={styles.card__description}>Соединительные комплекты для компрессорно-конденсаторных блоков (ККБ).</p>
          </div>
        </div>
      </div>
    </NavLink>
